...
public class Proveedorbd {
    ...
    public boolean Registrarproveedor(Proveedor proveedor) {
        ...
        if (proveedor.getFecha_vencimiento() == null) {
            ...
            sql = "INSERT INTO `ejercicio`.`proveedor` ("
                    + "`ruc`, "
                    + "`razon_social`, "
                    + "`tipo_actividad`, "
                    + "`nombre_representante`, "
...
//            con.close();
    ...
    public boolean eliminarProveedor(Proveedor proveedor) {
        ...
        String sql = "DELETE FROM `ejercicio`.`proveedor` WHERE (`idproveedor` = '"
    ...
    public boolean editar(Proveedor proveedor) throws SQLException {
        ...
        String sql = "UPDATE `ejercicio`.`proveedor` SET "
    ...
    public List<Proveedor> buscarProveedorNombre(String nombre) {
        ...
        String sql = "SELECT * FROM ejercicio.proveedor where nombre_representante like \"%" + nombre + "%\"";
    ...
    public List<Proveedor> buscarProveedorRuc(String ruc) {
        ...
        ResultSetImpl rs;
        List<Proveedor> proveedorEncontrado = new ArrayList<>();
        String sql = "SELECT * FROM ejercicio.proveedor where ruc like \"%" + ruc + "%\"";
